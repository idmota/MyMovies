...
//	var delegate:
	...
	private func fillModel() {
		self.menuModels = [
			...
			CommonsMenuModel(name: "New movie", icon: nil, urlLink: Url.getUrlFromCategory(.latest, page: 0)),
			//  Today in cinema
			// https://api.themoviedb.org/3/movie/now_playing?api_key=<<api_key>>&language=en-US&page=1
			CommonsMenuModel(name: "Today in cinema", icon: nil, urlLink: Url.getUrlFromCategory(.now_playing, page: 0)),
			// https://api.themoviedb.org/3/movie/popular?api_key=<<api_key>>&language=en-US&page=1
			CommonsMenuModel(name: "Popular", icon: nil, urlLink: Url.getUrlFromCategory(.popular, page: 0)),
			// https://api.themoviedb.org/3/movie/top_rated?api_key=<<api_key>>&language=en-US&page=1
			CommonsMenuModel(name: "Top Rated", icon: nil, urlLink: Url.getUrlFromCategory(.top_rated, page: 0)),
			// https://api.themoviedb.org/3/movie/upcoming?api_key=<<api_key>>&language=en-US&page=1
			CommonsMenuModel(name: "Upcoming", icon: nil, urlLink: Url.getUrlFromCategory(.upcoming, page: 0))
/*
			// https://api.themoviedb.org/3/movie/latest?api_key=<<api_key>>&language=en-US
			// https://api.themoviedb.org/3/movie/now_playing?api_key=<<api_key>>&language=en-US&page=1
			// https://api.themoviedb.org/3/movie/popular?api_key=<<api_key>>&language=en-US&page=1
